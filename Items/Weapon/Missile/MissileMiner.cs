...
public class MissileMiner : Missile, IExplodable{
    public void Activate(HeroType heroType, GameObject activator){

        if (isDone) { return; }
        isDone = true;

        bombActivator = heroType;
        bombActivatorGo = activator;
    ...
    public void OnCollisionEnter(Collision collision){
        ...
        try{
            ...
            if (collision.gameObject.GetComponent<Missile>() && 
                !collision.gameObject.GetComponent<MissileMiner>()){
