...
public class AIMovableMissiledVersusPlayerDouble : AIMoveableMissiledVersusPlayer
{

    [SerializeField] protected Transform shootPlace2;

   protected int currentShootPlaceChoose = 1;
  ...
  protected new void Shoot(){
        ...
        missileScript.MoveToKinematic(dir);
