...
public class AIMoveableMissiledEnemyFootball : AIMoveableMissiled
{
    ...
    void Update()
    {
        ...
        if (ball.GetComponent<FootballCollision>().ballOwner == HeroType.Helper)
        {
            ...
            if (IsNearest(this.gameObject, ball, "FootballEnemy"))
            {
            ...
            else
            {
                ...
                aim = GetNearestOpponent(this.gameObject, "FootballHelper");
    ...
    void EquipBall(GameObject ball)
    {
        ...
        ball.GetComponent<FootballCollision>().ballOwner = HeroType.Enemy;
